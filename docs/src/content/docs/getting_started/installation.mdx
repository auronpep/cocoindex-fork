...
description: >
  ...
  Python 3.11 to 3.14 on macOS, Linux, or Windows.
meta:
  time: ~3 minutes
...
1. Install [Python](https://wiki.python.org/moin/BeginnersGuide(2f)Download.html). We support Python 3.11 to 3.14.
